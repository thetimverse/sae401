 ...
 */
final class Version20230327145605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mot_partie (id INT AUTO_INCREMENT NOT NULL, mot_id INT DEFAULT NULL, partie_id INT DEFAULT NULL, position INT NOT NULL, couleur_j1 VARCHAR(10) NOT NULL, couleur_j2 VARCHAR(10) NOT NULL, jeton_j1 TINYINT(1) NOT NULL, jeton_j2 TINYINT(1) NOT NULL, trouve TINYINT(1) NOT NULL, INDEX IDX_D97116963977652 (mot_id), INDEX IDX_D971169E075F7A4 (partie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
