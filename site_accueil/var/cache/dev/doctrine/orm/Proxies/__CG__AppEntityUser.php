...
class User extends \App\Entity\User implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'partiesJ1' => [parent::class, 'partiesJ1', null],
        "\0".parent::class."\0".'partiesJ2' => [parent::class, 'partiesJ2', null],
        "\0".parent::class."\0".'partiesTour' => [parent::class, 'partiesTour', null],
        ...
        'partiesJ1' => [parent::class, 'partiesJ1', null],
        'partiesJ2' => [parent::class, 'partiesJ2', null],
        'partiesTour' => [parent::class, 'partiesTour', null],
